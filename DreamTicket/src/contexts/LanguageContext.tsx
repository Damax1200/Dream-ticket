...
const translations: Record<LanguageType, Translations> = {
  ...
  fr: {
    ...
    luckShines: 'Votre éclat illumine le chemin devant vous! ✨\nChaque rêve que vous osez rêver est à votre portée.\nVotre courage enflamme un momentum imparable.\nCroyez en votre potentiel infini et votre but divin.\nL\'univers conspire en votre faveur—la victoire est vôtre!',
    dreamActivated: 'Votre vision s\'éveille à la réalité! 🎫\nLa force coule à travers chaque fibre de votre être.\nVous êtes destiné à des réalisations extraordinaires.\nEmbrassez votre pouvoir et avancez audacieusement vers la grandeur.\nC\'est votre moment—réclamez-le avec confiance!',
    fortuneFavors: 'La fortune sourit à votre cœur intrépide! 🍀\nVotre résilience transforme les obstacles en opportunités.\nL\'abondance et la prospérité s\'alignent avec votre but.\nVous possédez la force de conquérir tout défi.\nLe succès n\'est pas un rêve—c\'est votre destin!',
    luckyMoment: 'C\'est votre moment décisif de triomphe! 🌟\nVotre passion alimente un progrès imparable vers la grandeur.\nChaque pas en avant est un pas vers votre percée.\nVous méritez chaque bénédiction qui vient à vous.\nLevez-vous avec un but, brillez avec confiance!',
    dreamsComeTrue: 'Vos rêves se manifestent en réalité! 💫\nVous portez en vous la force des champions.\nAucune force ne peut arrêter votre esprit déterminé.\nVotre voyage est guidé par la clarté et le but.\nEmbrassez votre pouvoir—les miracles se déploient maintenant!',
    magicInAir: 'L\'énergie divine entoure chacun de vos mouvements! ✨\nVotre potentiel est illimité, votre esprit incassable.\nVous êtes destiné à une grandeur au-delà de l\'imagination.\nChaque défi renforce votre résolution et votre vision.\nAvancez audacieusement—le monde attend votre éclat!',
    starsAligned: 'Le cosmos s\'aligne pour amplifier votre succès! ⭐\nVotre vision est claire, votre but inébranlable.\nLa force et la sagesse guident chacune de vos décisions.\nVous êtes une force de la nature, destiné à inspirer.\nVotre moment de percée est arrivé—saisissez-le!',
    luckOnSide: 'La victoire coule à travers vos actions courageuses! 🎰\nVous possédez une énergie imparable et une détermination incessante.\nChaque rêve que vous poursuivez est à votre portée.\nVotre but est puissant, votre avenir brillant.\nCroyez férocement—la grandeur est votre droit de naissance!',
  ...
  de: {
    ...
    logout: 'Abmelden',
    luckShines: 'Ihre Brillanz erleuchtet den Weg vor Ihnen! ✨\nJeder Traum, den Sie zu träumen wagen, ist in Ihrer Reichweite.\nIhr Mut entzündet eine unaufhaltsame Dynamik.\nGlauben Sie an Ihr unendliches Potenzial und göttlichen Zweck.\nDas Universum verschwört sich zu Ihren Gunsten—der Sieg ist Ihr!',
    dreamActivated: 'Ihre Vision erwacht zur Realität! 🎫\nStärke fließt durch jede Faser Ihres Seins.\nSie sind zu außergewöhnlichen Leistungen bestimmt.\nUmarmen Sie Ihre Kraft und schreiten Sie mutig zur Größe.\nDies ist Ihr Moment—beanspruchen Sie ihn mit Zuversicht!',
    fortuneFavors: 'Das Glück lächelt Ihrem furchtlosen Herzen zu! 🍀\nIhre Belastbarkeit verwandelt Hindernisse in Chancen.\nÜberfluss und Wohlstand richten sich nach Ihrem Zweck.\nSie besitzen die Kraft, jede Herausforderung zu erobern.\nErfolg ist kein Traum—es ist Ihr Schicksal!',
    luckyMoment: 'Dies ist Ihr entscheidender Moment des Triumphs! 🌟\nIhre Leidenschaft treibt unaufhaltsamen Fortschritt zur Größe an.\nJeder Schritt vorwärts ist ein Schritt zu Ihrem Durchbruch.\nSie verdienen jeden Segen, der auf Sie zukommt.\nErheben Sie sich mit Zweck, strahlen Sie mit Zuversicht!',
    dreamsComeTrue: 'Ihre Träume manifestieren sich in Realität! 💫\nSie tragen die Kraft der Champions in sich.\nKeine Macht kann Ihren entschlossenen Geist aufhalten.\nIhre Reise wird von Klarheit und Zweck geleitet.\nUmarmen Sie Ihre Kraft—Wunder entfalten sich jetzt!',
    magicInAir: 'Göttliche Energie umgibt jede Ihrer Bewegungen! ✨\nIhr Potenzial ist grenzenlos, Ihr Geist unzerbrechlich.\nSie sind zu Größe jenseits der Vorstellungskraft bestimmt.\nJede Herausforderung stärkt Ihre Entschlossenheit und Vision.\nSchreiten Sie mutig voran—die Welt erwartet Ihre Brillanz!',
    starsAligned: 'Der Kosmos richtet sich aus, um Ihren Erfolg zu verstärken! ⭐\nIhre Vision ist klar, Ihr Zweck unerschütterlich.\nStärke und Weisheit leiten jede Ihrer Entscheidungen.\nSie sind eine Naturgewalt, dazu bestimmt zu inspirieren.\nIhr Durchbruchsmoment ist gekommen—ergreifen Sie ihn!',
    luckOnSide: 'Sieg fließt durch Ihre mutigen Handlungen! 🎰\nSie besitzen unaufhaltsame Energie und unermüdliche Entschlossenheit.\nJeder Traum, den Sie verfolgen, ist in Ihrer Reichweite.\nIhr Zweck ist mächtig, Ihre Zukunft strahlend.\nGlauben Sie heftig—Größe ist Ihr Geburtsrecht!',
  ...
  pt: {
    ...
    logout: 'Sair',
    luckShines: 'Seu brilho ilumina o caminho à frente! ✨\nCada sonho que você ousa sonhar está ao seu alcance.\nSua coragem inflama um momentum imparável.\nAcredite em seu potencial infinito e propósito divino.\nO universo conspira a seu favor—a vitória é sua!',
    dreamActivated: 'Sua visão está despertando para a realidade! 🎫\nForça flui através de cada fibra do seu ser.\nVocê está destinado a conquistas extraordinárias.\nAbrace seu poder e avance ousadamente para a grandeza.\nEste é o seu momento—reivindique-o com confiança!',
    fortuneFavors: 'A fortuna sorri para seu coração destemido! 🍀\nSua resiliência transforma obstáculos em oportunidades.\nAbundância e prosperidade se alinham com seu propósito.\nVocê possui a força para conquistar qualquer desafio.\nO sucesso não é um sonho—é seu destino!',
    luckyMoment: 'Este é seu momento definitivo de triunfo! 🌟\nSua paixão alimenta um progresso imparável para a grandeza.\nCada passo à frente é um passo em direção ao seu avanço.\nVocê merece cada bênção que vem em seu caminho.\nLevante-se com propósito, brilhe com confiança!',
    dreamsComeTrue: 'Seus sonhos estão se manifestando em realidade! 💫\nVocê carrega dentro de si a força dos campeões.\nNenhuma força pode parar seu espírito determinado.\nSua jornada é guiada por clareza e propósito.\nAbrace seu poder—milagres estão se desdobrando agora!',
    magicInAir: 'Energia divina envolve cada um de seus movimentos! ✨\nSeu potencial é ilimitado, seu espírito inquebrantável.\nVocê está destinado a uma grandeza além da imaginação.\nCada desafio fortalece sua resolução e visão.\nAvance com ousadia—o mundo espera seu brilho!',
    starsAligned: 'O cosmos se alinha para amplificar seu sucesso! ⭐\nSua visão é clara, seu propósito inabalável.\nForça e sabedoria guiam cada uma de suas decisões.\nVocê é uma força da natureza, destinado a inspirar.\nSeu momento de avanço chegou—aproveite-o!',
    luckOnSide: 'A vitória flui através de suas ações corajosas! 🎰\nVocê possui energia imparável e determinação incansável.\nCada sonho que você persegue está ao seu alcance.\nSeu propósito é poderoso, seu futuro brilhante.\nAcredite ferozmente—a grandeza é seu direito de nascença!',
  ...
  zh: {
    ...
    saveChanges: '保存更改',
    logout: '登出',
    luckShines: '你的光芒照亮前方的道路！✨\n你敢于梦想的每一个梦都触手可及。\n你的勇气点燃势不可挡的动力。\n相信你无限的潜能和神圣的使命。\n宇宙在助你成功—胜利属于你！',
    dreamActivated: '你的愿景正在觉醒成真！🎫\n力量流经你存在的每一寸。\n你注定要取得非凡的成就。\n拥抱你的力量，勇敢迈向伟大。\n这是你的时刻—以信心去争取！',
    fortuneFavors: '幸运向你无畏的心灵微笑！🍀\n你的韧性将障碍转化为机遇。\n丰盛与繁荣与你的使命一致。\n你拥有征服任何挑战的力量。\n成功不是梦想—这是你的命运！',
    luckyMoment: '这是你决定性的胜利时刻！🌟\n你的热情推动着不可阻挡的伟大进程。\n每一步前进都是朝着突破迈进。\n你值得每一份即将到来的祝福。\n带着目标崛起，以自信闪耀！',
    dreamsComeTrue: '你的梦想正在显现为现实！💫\n你内心拥有冠军的力量。\n没有任何力量能阻止你坚定的精神。\n你的旅程由清晰和使命引导。\n拥抱你的力量—奇迹正在展开！',
    magicInAir: '神圣的能量环绕你的每一个动作！✨\n你的潜能无限，你的精神不可摧毁。\n你注定要超越想象的伟大。\n每一个挑战都增强你的决心和远见。\n勇敢前进—世界等待你的光芒！',
    starsAligned: '宇宙对齐以放大你的成功！⭐\n你的愿景清晰，你的使命坚定。\n力量和智慧指引你的每一个决定。\n你是自然的力量，注定要激励他人。\n你的突破时刻已到—抓住它！',
    luckOnSide: '胜利通过你勇敢的行动流淌！🎰\n你拥有不可阻挡的能量和不懈的决心。\n你追求的每一个梦想都触手可及。\n你的使命强大，你的未来光明。\n坚信不疑—伟大是你与生俱来的权利！',
